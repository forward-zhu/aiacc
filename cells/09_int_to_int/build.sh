...
DPI_SRC="${CELL_DIR}/csrc/int_to_int_dpi.c"      # DPI 源文件
DPI_LIB_BASENAME="int_to_int_dpi"              # 生成 lib${BASENAME}.so 并链接 -l${BASENAME}
...
# Verilog 源文件
VSRC_FILES=(
    "${CELL_DIR}/vsrc/int_to_int_array.v"
    "${CELL_DIR}/vsrc/int_to_int.v"
    "${CELL_DIR}/vsrc/tb_int_to_int_array.v"
    # "${CELL_DIR}/vsrc/tb_int_to_int.v"
)
